...
const ResponsiveAppBar = () => {
    ...
    return (
        <AppBar position="static" sx={{bgcolor: '#282828', padding: 0, margin: 0, flexDirection:'row'}} >
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    <MyLocationIcon sx={{display: {xs: 'none', md: 'flex'}, mr: 1}}/>
                    <Typography
                        variant="h6"
                        noWrap
                        component="a"
                    ...
                    >
                        <p className="textLogo">
                            Artillery Positioning System
                            <span className="textLogoBody">Tactical Maps</span>
                        </p>
                    </Typography>
